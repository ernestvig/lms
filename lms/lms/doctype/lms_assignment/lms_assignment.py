...
def create_enhanced_assignment():
    ...
    """
    import json
    from frappe.utils import now, generate_hash, getdate
    ...
    try:
        ...
        if (data.get("type") == "Quiz/Multiple choice" and 
            "quiz_questions" in data and isinstance(data["quiz_questions"], list)):
...
def get_enhanced_assignment_detail(assignment_name):
    ...
    try:
        ...
        """, {"assignment_name": assignment_name}, as_dict=True)
...
def get_assignments_for_student(student_email):
    ...
    try:
        ...
        """, {"student_email": student_email}, as_dict=True)
...
def submit_assignment_response():
    ...
    try:
        ...
        is_assigned = frappe.db.exists("Assignment Student", {
            "parent": assignment_name,
